...
Installation:
clone this repo and `cd` into it. From there run: `pip install -e .` and `gitswitch` is available in that environment.
NOTE: if you use a version manager like asdf, you may need to reshim to make the command available.
